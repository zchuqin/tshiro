...
//        map.put("/logout", "logout");
    ...
    @Bean
    public DefaultWebSessionManager defaultWebSessionManager(SimpleCookie simpSessionIdCookie, ShiroSessionListener shiroSessionListener) {
